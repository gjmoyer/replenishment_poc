...
CORE_SKUS: tuple[Sku, ...] = (
    Sku("milk-1gal-001", "Milk 1gal", 24, 6, popularity=20, opening_boh=180,
        multi_unit_prob=0.15, pack="1 gal jug"),
    ...
    Sku("dogfood-40lb-007", "Bulk Dog Food 40lb", 6, 2, is_bulk=True,
        popularity=0.8, opening_boh=30, pack="40 lb bag"),
    Sku("bread-loaf-003", "Bread Loaf", 30, 10, popularity=12,
        profile="morning", opening_boh=135, pack="20 oz loaf"),
    Sku("eggs-12ct-005", "Eggs Dozen", 36, 12, popularity=12,
        profile="morning", opening_boh=162, pack="12 ct carton"),
)

BASE_FILLERS: tuple[Sku, ...] = (
    Sku("cereal-001", "Cereal", 24, 6, popularity=8,
        profile="morning", opening_boh=108, pack="18 oz box"),
    Sku("pasta-001", "Pasta", 30, 10, popularity=6, opening_boh=90, pack="16 oz box"),
    Sku("beans-001", "Canned Beans", 36, 12, popularity=5, opening_boh=108, pack="15 oz can"),
    Sku("chips-001", "Chips", 30, 6, popularity=7,
        profile="evening", opening_boh=90, pack="13 oz bag"),
    Sku("coffee-001", "Coffee", 20, 5, popularity=9,
        profile="morning", opening_boh=90, pack="12 oz bag"),
)
